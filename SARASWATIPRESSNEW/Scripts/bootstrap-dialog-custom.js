...
for (var i = howManyDialogs; i >= 0; i--) {
    var dialog = new BootstrapDialog({
        title: 'Dialog No.' + i,
        message: function () {
            var msg = 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit, natus, praesentium, earum enim ea impedit magni laborum non officia provident voluptates ex facilis voluptatum delectus rerum nemo atque blanditiis tempora!';
            for (var n = i ; n >= 0; n--) {
                msg += msg;
            }
